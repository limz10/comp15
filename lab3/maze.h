...
public:
    ...
    void generate_maze();
    void solve_maze_recursive() {solve_maze_recursive(1,1); maze[1][1]='S';}
    void solve_maze_stack() { solve_maze_stack(1,1); maze[1][1]='S'; }
...
private:
    ...
    void init_maze();
    void maze_generator(int index, int backtrack_x[CELL], int bactrack_y[CELL], 
